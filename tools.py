...
def ConvertToVector( liste, variable ):
    if ( IsRealVar( liste ) ):
        return Discretize(liste, variable)
    else:
        value = 0
...
if __name__ == "__main__":
    # going to need something that makes it in accordance with pos and neg
    #v1 = ConvertToVector(["Yes","No", "Yes", "Yes", "No", "asda"])
    #v2 = ConvertToVector(["Yes","No", "Yes", "Yes", "No", "asda"])
    #v1 = TemporaryHack(v1)
    #v2 = TemporaryHack(v2)
    ...
    #print(ComputeProbAB(v1, v2, 1, 1))
    print("hello world")
    
    #print(ComputeMutualInfo(v1, v2))